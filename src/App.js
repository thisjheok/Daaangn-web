  ...
  return (
          ...
          <div className='main-banner'>
            ...
            <div className='second-banner'>
              <div>
                ...
                <h2 className='sec-title'>믿을만한 이웃 간 중고거래</h2>
    ...
    <div className='second-banner'>
        <div>
          ...
          <h2 className='sec-title'>걸어서 10분! 동네 알바 구하기</h2>
      ...
      <div className='fourth-banner'>
        <div className='fourth-banner-content'>
          ...
          <h2 className='sec-title'>내 근처에서 찾는 동네업체</h2>
